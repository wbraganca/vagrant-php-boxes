...
install_mysql_57() {
  wget --quiet -P /tmp http://dev.mysql.com/get/mysql-apt-config_0.5.3-1_all.deb
  ...
  dpkg -i /tmp/mysql-apt-config_0.5.3-1_all.deb > /dev/null 2>&1
  ...
  rm -rf /tmp/mysql-apt-config_0.5.3-1_all.deb
}
